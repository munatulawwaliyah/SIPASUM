...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const dropdownBtn = document.getElementById('dropdown-btn6');
            const dropdownMenu = document.getElementById('dropdown-menu6');
            const options = dropdownMenu.querySelectorAll('.option6');
            const inputField = document.getElementById('pelayanan_umum_dan_pemerintahan');
            ...
            options.forEach(function(option) {
                option.addEventListener('click', function() {
                    ...
                    dropdownBtn.textContent = option.textContent; // Update button text with selected option
            ...
            inputField.addEventListener('input', function() {
                ...
                if (value !== '') {
                    ...
                    dropdownMenu.classList.add('hidden'); // Hide the menu if input is empty
                }
            });
        });
    </script>
